import type { KnowledgeGalleryStep } from "./knowledge-gallery";

// Step-by-step body content for every gallery entry, keyed by slug.
// Split out of knowledge-gallery.ts so this prose is imported ONLY by the
